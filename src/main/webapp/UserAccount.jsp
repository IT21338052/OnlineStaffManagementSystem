...
<body class="sb-nav-fixed">
	...
	<%
	employee empDetails = (employee) request.getSession().getAttribute("empDetails");
		...
		<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
			<li class="nav-item dropdown"><a
				...
				<ul class="dropdown-menu dropdown-menu-end"
					...
					<li><a class="dropdown-item" href="#!"><%=empDetails.getName()%></a></li>
					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="UserAccount.jsp">View Account
									Details</a> <a class="nav-link" href="UpdateEmployee.jsp">Update
									Account Details</a>
							</nav>
						</div>
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
						...
						<ul class="form-section page-section">
							<li id="cid_19" class="form-input-wide" data-type="control_head">
								<div class="form-header-group  header-default">
									<div class="header-text httal htvam">
										<h2 id="header_19" class="form-header" data-component="header">Enter
											Employee Details</h2>
							...
							<li class="form-line jf-required" data-type="control_textbox"
								...
								<div id="cid_4" class="form-input jf-required">
									<input type="text" id="id" name="id" data-type="input-textbox"
										class="form-textbox validate[required]" data-defaultvalue=""
										size="20" value="<%=empDetails.getId()%>" placeholder=" "
							...
							<li class="form-line jf-required" data-type="control_textbox"
								...
								<div id="cid_4" class="form-input jf-required">
									<input type="text" id="name" name="name"
										...
										readonly data-component="textbox" aria-labelledby="label_4" />
								</div></li>
							...
							<li class="form-line jf-required" data-type="control_dropdown"
								...
								<div id="cid_22" class="form-input jf-required">
									<select class="form-dropdown validate[required]" id="gender"
										...
										required="">
										<option value="<%=empDetails.getGender()%>"></option>
									...
									<div data-wrapper-react="true">
										<span class="form-sub-label-container"
											...
											aria-labelledby="label_9 sublabel_9_day">
												<option value="<%=empDetails.getDobDay()%>"></option>
											...
											aria-labelledby="label_9 sublabel_9_month">
												<option value="<%=empDetails.getDobMonth()%>"></option>
							...
							<li class="form-line" data-type="control_email" id="id_24"><label
								...
								<div id="cid_24" class="form-input">
									<span class="form-sub-label-container"
										...
										data-defaultvalue="" size="30" readonly
							...
							<li class="form-line jf-required" data-type="control_dropdown"
								id="id_22"><label
								class="form-label form-label-left form-label-auto" id="label_22"
								for="input_22">Job Position <span class="form-required">
								</span>
							</label>
								<div id="cid_22" class="form-input jf-required">
							...
							<li class="form-line jf-required" data-type="control_dropdown"
								id="id_22"><label
								class="form-label form-label-left form-label-auto" id="label_22"
								for="input_22">Department <span class="form-required">
								</span>
							</label>
								<div id="cid_22" class="form-input jf-required">
									<select class="form-dropdown validate[required]"
							...
							<li class="form-line jf-required" data-type="control_textbox"
								...
								<div id="cid_4" class="form-input jf-required">
									<input type="password" id="password" name="password"
										data-type="input-textbox" readonly
										class="form-textbox validate[required]" data-defaultvalue=""
										size="20" value="<%=empDetails.getPassword()%>"
										placeholder=" " data-component="textbox"
										aria-labelledby="label_4" />
								</div></li>
								...
								<div id="cid_25" class="form-input-wide">
									<div style="margin-left: 156px" data-align="auto"
										...
										<button id="input_25" type="submit"
											onclick="updateEmployee.jsp" formaction="updateEmployee.jsp"
